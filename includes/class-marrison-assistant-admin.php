...
class Marrison_Assistant_Admin {
    ...
    public function register_settings() {
        ...
        // SMS provider
        register_setting('marrison_assistant_settings', 'marrison_sms_provider');
        // SMS Aruba
        ...
        // SMS Tools
        register_setting('marrison_assistant_settings', 'marrison_smstools_client_id');
        register_setting('marrison_assistant_settings', 'marrison_smstools_client_secret');
        register_setting('marrison_assistant_settings', 'marrison_smstools_sender');
    }
